...
"./docs/io/Java24/Benchmark/run_tests_24.sh" [RUN_COUNT] [TOKEN_COUNT] [STRING_PRINT_COUNT]
```

```bat
:: Windows
"docs\io\Java24\Benchmark\run_tests_24.bat" [RUN_COUNT] [TOKEN_COUNT] [STRING_PRINT_COUNT]
```
...
1. 比較したい実装（例: `FastScanner3.java`）を`test/verify/io/bench24/`に置く
