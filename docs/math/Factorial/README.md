...
### [FactorialTable](../../../src/lib/math/FactorialTable.java)
...
### [FactorialNaive](../../../src/lib/math/FactorialNaive.java)

- 用途: 小規模検証や単純な計算用のナイーブ実装（事前計算なし）
- 提供メソッド: fact(n), modFact(n, mod), invFact(n, mod)

### [Example](../../../test/verify/math/factorial/Example.java)
...
```
javac --release 24 -encoding UTF-8 -d out "src\lib\math\FactorialTable.java" "src\lib\math\FactorialNaive.java"
// 任意の Main を用意した場合
