...
### 1. [LongBIT](../../../src/lib/ds/LongBIT.java) / [IntBIT](../../../src/lib/ds/IntBIT.java)
...
### 2. [BIT<T>](../../../src/lib/ds/BIT.java)

- **用途**: 汎用的な型 `T` と任意の二項演算を扱うBIT
- **特徴**: 逆演算を提供することで、区間和や値の更新にも対応可能

### 3. [LongBIT2D](../../../src/lib/ds/LongBIT2D.java) / [IntBIT2D](../../../src/lib/ds/IntBIT2D.java)
...
### 4. [LongRangeBIT](../../../src/lib/ds/LongRangeBIT.java) / [IntRangeBIT](../../../src/lib/ds/IntRangeBIT.java)
