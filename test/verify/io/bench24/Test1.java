...
public final class Test1 {
	...
	private static long benchPrintlnInt(final FastPrinter out, final int n) {
		long x = 0x1234ABCDL;
	...
	private static long benchPrintlnLong(final FastPrinter out, final int n) {
	...
	private static long benchPrintlnString(final FastPrinter out, final int n) {
		final long t = System.nanoTime();
		for (int i = 0; i < n; i++) {
	...
	private static long benchPrintlnBoolean(final FastPrinter out, final int n) {
		final long t = System.nanoTime();
		for (int i = 0; i < n; i++) {
			out.println((i & 1) == 0);
		}
	...
	public static void main(String[] args) {
		...
		final FastPrinter out = new FastPrinter(OutputStream.nullOutputStream(), 1 << 20, false);
		...
		System.out.println("RESULT,Test1," + n + "," + STRING_LEN + "," + psn + "," + nextIntNs + "," + nextLongNs + "," + nextNs + "," + scannerInitNs + "," + nextTotalNs + "," + scannerWithNextTotalNs + "," + sumInt + "," + sumLong + "," + strHash + "," + printlnIntNs + "," + printlnLongNs + "," + printlnStringNs + "," + printlnBoolNs + "," + mainTotalNs + "," + appTotalNs);
	}
}
