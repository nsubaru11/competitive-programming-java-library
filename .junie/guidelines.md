...
- 注意
	...
	- 想定JDKは Java 24（24.0.2）。FastIO17 のみ Java 17 互換です。
	- エンコーディングは UTF-8 を推奨。
...
- パフォーマンステスト：各ディレクトリのベンチマーク資料を参照し、必要に応じて入力規模を変えて確認する。
...
- FastIO 系
	- 高速入力: FastScanner（FastIO17 = Java 17 互換、FastIO24 = Java 24 最適化）
	- 高速出力: FastPrinter（FastIO17 = Java 17 互換、FastIO24 = Java 24 最適化）
- 平衡 BST 系
